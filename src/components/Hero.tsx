  ...
  return (
    <section className=" flex  min-h-screen items-center justify-center bg-primary-5 bg-main bg-cover bg-center text-white ">
      <div className=" px-12 text-center md:max-w-5xl">
        ...
        <button className="border-2 bg-white px-6 py-4 text-xl font-light uppercase tracking-widest text-primary-4 shadow transition-colors duration-300 ease-in-out hover:bg-transparent hover:text-white">
          Explore Tours
        </button>
      </div>
    </section>
